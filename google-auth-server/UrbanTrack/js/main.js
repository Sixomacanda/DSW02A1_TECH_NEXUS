...
(function () {
  ...
  if (mobileBtn && navLinks) {
    mobileBtn.addEventListener("click", function (e) {
      e.stopPropagation();
      const isOpen =
        navLinks.style.display === "flex" && window.innerWidth <= 768;
      if (isOpen) {
...
>>>>>>> d71744ac2cc31a3e4eb8fd582d854fe3c6af24fc:google-auth-server/UrbanTrack/js/main.js
